...
# Bajar el archivo y ponerlo en el directorio de trabajo
...
#El archivo es descomprimido manualmente y se extrae una carpeta denominada UCI HAR Dataset
...
#  5. From de data set in step 4, creates a second, independent tidy data set...
